...
rule upload_to_s3:
    ...
    shell:
        ...
        [[ -d bin ]] || mkdir bin
        [[ -f bin/upload-to-s3 ]]          || $download_cmd bin/upload-to-s3 "https://raw.githubusercontent.com/nextstrain/monkeypox/644d07ebe3fa5ded64d27d0964064fb722797c5d/ingest/bin/upload-to-s3"
        [[ -f bin/sha256sum ]]             || $download_cmd bin/sha256sum "https://raw.githubusercontent.com/nextstrain/monkeypox/644d07ebe3fa5ded64d27d0964064fb722797c5d/ingest/bin/sha256sum"
        [[ -f bin/cloudfront-invalidate ]] || $download_cmd bin/cloudfront-invalidate "https://raw.githubusercontent.com/nextstrain/monkeypox/644d07ebe3fa5ded64d27d0964064fb722797c5d/ingest/bin/cloudfront-invalidate"
        chmod +x bin/*
